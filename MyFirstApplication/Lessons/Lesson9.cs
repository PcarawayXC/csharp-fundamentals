...
internal class Lesson9
{
    ...
    /*
     Private access modifier can only be seen with the class, struct, or nested type
     */
    ...
    /*
    Protected internal can be seen within the assembly or child(derived) class from another assembly
    */
    ...
    public class Nested
    {
        ...
        {
            Console.WriteLine($"Lesson9 Value is {parent._value}");
        }
    }// end nested class
} // end class