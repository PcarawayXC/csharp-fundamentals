...
internal class Lesson3
{
    ...
    // Unckecked will removed the exception from constant values
    ...
    public void BasicMath()
    {
        ...
        Console.WriteLine($"Multiplication = {multiplyTotal}, Divison = {divideTotal}");
    }
    // Modulus Operator
    ...
    public void RelationalOperatorExample(string name, string beta)
    {
