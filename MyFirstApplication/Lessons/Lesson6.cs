...
internal class Lesson6
{
    ...
    /*
     The in parameter modifier is passed by reference. the argument can not be modified as it is readonly
     */
    ...
    /*
     The ref parameter is passed by reference. The value changed
    in the method affects the called variable.
     */
    public void RefExample(ref int value)
    {
        value += 5;
        Console.WriteLine($"RefExample +5 = {value}");
    }
    /*
